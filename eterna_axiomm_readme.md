...
Eterna Axiomm is a modern **Next.js + TypeScript** web application built with a clean file structure and scalable architecture. This project follows the App Router pattern, uses modular components, hooks, utilities, and ships with an optimized production-ready setup.

---

## Live Demo
Visit: **https://eterna-axiomm.vercel.app/**
...
```bash
git clone https://github.com/Shreya-Mondal12/eterna-axiomm.git
cd eterna-axiomm
```
